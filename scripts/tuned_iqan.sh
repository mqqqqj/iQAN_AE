...
100 output.ivecs /SSD/DEEP10M/gt.100M.top100.bin $thread_num "$L_str" | tee -a ./deep100m_8t_tuned_iqan.csv
...
100 output.ivecs /SSD/Glove200/gt.query.top100.bin $thread_num "$L_str" | tee -a ./glove200_8t_tuned_iqan.csv
...
100 output.ivecs /SSD/WebVid/gt.query.top100.bin $thread_num "$L_str" | tee -a ./webvid_8t_tuned_iqan.csv
...
100 output.ivecs /SSD/LAION/gt.test50K.bin $thread_num "$L_str" | tee -a ./laion10m_8t_tuned_iqan.csv
